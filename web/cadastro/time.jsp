...
<html lang="pt">
    ...
    <body class="body-home">
                ...
                <div class="col-sm-12">
                    <form class="form" action="##" method="post" id="register">
                        <div class="form-group">
                            <div class="col-xs-12">
                                <label>Nome do Time</label><label class="asterisco">*</label>
                        ...
                        <div class="col-xs-6">
                            ...
                            <label>Número de jogarores</label><label class="asterisco">*</label>
                        ...
                        <div class="col-xs-6" style="margin-bottom: 10%">
                            ...
                            <button class="btn btn-lg btn-primary" onclick="prosseguir()" style="float: right" type="button"> </i>Prosseguir</button>
                        </div>
                        <p></p>
                    </form>           
                </div>
        ...
        <script src="../js/time/cadastro.js"></script>
