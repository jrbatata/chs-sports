...
<html lang="pt">
    ...
    <body class='body-home'>      
                ...
                <div class="col-sm-12">
                    <form class="form" action="##" method="post" id="register">
                        ...
                        <div class="col-xs-6" style="margin-bottom: 2%">
                            ...
                            <button class="btn btn-lg btn-primary" style="float: right" onclick="alterarDados()" type="button"> </i>Alterar</button>
                        </div>
                        <p></p>
                    </form>
                </div>
        ...
        <script src="../js/campeonato/alterar.js"></script>
    </body>
